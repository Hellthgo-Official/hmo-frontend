...
import { PlanList, getPlanIcon } from '../../utils/data/Plans';
                ...
                <div key={id} className="border border-primary p-3 rounded-lg">
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm font-light">
                      ₦{price ? price.toLocaleString() : 0} per year
                    </p>
                  </div>
                  ...
                  <div className="flex justify-between">
                    <div className="flex items-center gap-x-3">
                      ...
                      <p className="text-sm font-medium">
                        Deposit: ₦
                        {initial_deposit ? initial_deposit.toLocaleString() : 0}
                      </p>
                    </div>
                    <CustomButton
                      linkRoute={generateParams(id)}
                      linkTitle="Next"
                    />
                  </div>
                </div>
