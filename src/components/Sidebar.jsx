...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => {
          handleNavigate('/pay-next-amount');
        }}
        className={`${pathName === '/pay-next-amount' ? 'bg-secondaryBG text-white font-bold' : 'text-black-200 font-light'} w-full rounded-lg h-16 flex items-center px-5 space-x-3`}
      >
        <svg
          width="24"
          height="24"
        ...
        >
          <g clipPath="url(#clip0_4537_4173)">
            <path
              ...
              fill="#ACB4B0"
              className={`${pathName === '/pay-next-amount' ? 'fill-white' : 'fill-[#ACB4B0]'}  group-hover:fill-white`}
            />
          </g>
          <defs>
